...
void reconnect()
{
  ...
  while (!client.connected())
  {
    ...
    if (client.connect("segment4"))
    {
      Serial.println("connected");
      // Subscribe
      //client.subscribe("input/#");
      client.subscribe("TrappenMaar/segment4");
    }
    else
    {
...
else if((mess == "resetSegment4")){
    Serial.println("Restarting in 10 seconds");
    delay(10000);
    ESP.restart();
    Serial.println("Segment 4 is ook ready");
    client.publish("TrappenMaar/buffer", "Segment4 ready");
  }
