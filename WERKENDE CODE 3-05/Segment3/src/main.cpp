...
void reconnect()
{
  ...
  while (!client.connected())
  {
    ...
    if (client.connect("segment3"))
    {
      Serial.println("connected");
      // Subscribe
      //client.subscribe("input/#");
      client.subscribe("TrappenMaar/segment3");
    }
    else
    {
...
else if((mess == "resetSegment3")){
    Serial.println("Restarting in 10 seconds");
    delay(10000);
    ESP.restart();
    Serial.println("Segment 3 is ook ready");
    client.publish("TrappenMaar/buffer", "Segment3 ready");
  }
